...
import { TENANT_CONFIG } from "@/lib/clinicalTrials/tenantConfig";
...
export async function GET() {
  try {
    ...
    const requireVerification =
      TENANT_CONFIG[tenant]?.requireVerification === true;

    // Build query — note pgvector neon driver requires us to inline the conditional
    const trials = requireVerification
      ? await sql`
          SELECT
            nct_id,
